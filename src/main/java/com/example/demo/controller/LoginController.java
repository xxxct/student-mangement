        ...
        if (type.equals("2")) {
            ...
            if (StringUtils.isEmpty(username) || StringUtils.isEmpty(password)) {
                ...
                if (manager.getPassword().equals(password)) {
                    ...
                    if(manager.getType().equals("yxManager")){
                        return "yxManager";
                    }else if(manager.getType().equals("cwManager")){
                        return "cwManager";
                    }else if(manager.getType().equals("xtManager")){
                        return "xtManager";
                    }else if(manager.getType().equals("jwManager")){
                        return "jwManager";
                    }
                } else {
                    map.put("msg", "用户名或密码不正确");
